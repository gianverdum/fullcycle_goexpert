...
const (
	...
	CategoryService_CreateCategoryStreamBoth_FullMethodName = "/pb.CategoryService/CreateCategoryStreamBoth"
...
type CategoryServiceClient interface {
	...
	CreateCategoryStreamBoth(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error)
...
func (c *categoryServiceClient) CreateCategoryStreamBoth(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[CreateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], CategoryService_CreateCategoryStreamBoth_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBothClient = grpc.BidiStreamingClient[CreateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	CreateCategoryStreamBoth(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryStreamBoth(grpc.BidiStreamingServer[CreateCategoryRequest, Category]) error {
...
func _CategoryService_CreateCategoryStreamBoth_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryStreamBoth(&grpc.GenericServerStream[CreateCategoryRequest, Category]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_CreateCategoryStreamBothServer = grpc.BidiStreamingServer[CreateCategoryRequest, Category]
